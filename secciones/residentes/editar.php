...
if(isset($_GET['txtID'])){
    ...
    $sentencia = $conexion->prepare("SELECT * FROM `residentes` WHERE Cedula=:Cedula");
...
if ($_POST) {
    ...
    $sentencia = $conexion->prepare("UPDATE residentes SET Cedula=:Cedula, Primernombre=:Primernombre, Segundonombre=:Segundonombre, Primerapellido=:Primerapellido,
