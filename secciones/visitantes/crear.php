...
if ($_POST) {
    ...
    $sentencia = $conexion->prepare("INSERT INTO `visitantes` (`Cedula`, `Primernombre`, `Segundonombre`, `Primerapellido`, `Segundoapellido`, `Genero`, `Vehiculo`, `Apartamento`, `Fechaingreso`) 
